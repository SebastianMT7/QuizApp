...
function updateprogressBar() {
    ...
    percent = Math.round(percent * 100); //rundet das Ergebnis
...
function answer(selection) {
    let question = questions[currentQuestion];
    let selectedQuestionNumber = selection.slice(-1); //nimmt den letzten Buchstaben aus dem string(von der var answer_3 die 3. answer_3 wird durch onclick mit gegeben!!)
...
function restartGame() {
    document.getElementById('questionBody').style = ''; //fragen container wieder anzeigen
